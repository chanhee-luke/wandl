...
import frameCaptions from "../data/frame-captions.json";
...
<Figure>
    <ImageSlider altText="An example of our IDM being used to annotate an online video." captions={frameCaptions} />
</Figure>
